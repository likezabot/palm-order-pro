      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          <div className="flex justify-center mb-2">
            <div className="rounded-full bg-destructive/10 p-3 ring-4 ring-destructive/5">
        ...
        <AlertDialogFooter className="gap-2">
          <AlertDialogCancel disabled={submitting} className="min-h-[48px]">
            Voltar
          </AlertDialogCancel>
          <button
            onClick={handleConfirm}
            disabled={submitting}
            className="rounded-md bg-destructive px-4 py-2 font-black text-destructive-foreground disabled:opacity-40 min-h-[48px] flex items-center justify-center gap-2 hover:bg-destructive/90 transition-colors"
          >
            <X className="w-4 h-4" />
            {submitting ? "Cancelando..." : "Sim, cancelar pedido"}
          </button>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
