...
BEGIN
  ...
  -- 9. Cria ou vincula cliente
  v_customer_id := public.get_or_create_customer(v_norm_phone, p_customer_name);

  -- 10. Define nome da mesa e ETA
  v_table_name := CASE 
  ...
  -- 13. Processa transação de fidelidade (redeem) imediatamente se houver brinde
