-- Add restaurant_id to orders if it doesn't exist
DO $$ 
BEGIN
...
-- Update create_public_order to be more robust and fix the restaurant_id/table_name issue
...
BEGIN
  ...
  -- 7. Validação de Brinde (Se falhar, remove o brinde mas permite o pedido seguir)
